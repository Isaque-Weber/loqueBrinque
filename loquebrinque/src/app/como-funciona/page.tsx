...
import { Puzzle, Calendar, Truck, Smile } from "lucide-react"; // usando lucide-react
...
export default function ComoFuncionaPage() {
    return (
        <section className="py-16 md:py-24 lg:py-32 bg-gradient-to-b from-sky-100 to-blue-400 relative overflow-hidden">
