        ...
        <footer className="bg-orange-200 text-gray-800">
            ...
            <div className="max-w-7xl mx-auto px-8 py-12 grid grid-cols-1 md:grid-cols-3 gap-10 items-start">
                ...
                <div className="flex flex-col items-center md:items-start text-center md:text-left">
                    ...
                    />
                    <p className={`font-medium text-lg text-blue-700 ${sniglet.className}`}>
                ...
                <div className="flex flex-col items-center md:items-start space-y-3">
                    <h3 className={`font-medium text-lg text-blue-700 mb-2 ${sniglet.className}`}>
                        Navegação
                    </h3>
                    <Link href="/#brinquedos" className="hover:text-blue-600">Brinquedos</Link>
                    <Link href="/#como-funciona" className="hover:text-blue-600">Como Funciona</Link>
                    <Link href="/#depoimentos" className="hover:text-blue-600">Depoimentos</Link>
                ...
                <div className="flex flex-col items-center md:items-start space-y-4">
                    ...
                    <p className="flex items-center gap-2">
                        <Phone className="h-5 w-5 text-blue-600" /> (21) 96448-5810
                    </p>
                    <p className="flex items-center gap-2">
                        <Mail className="h-5 w-5 text-blue-600" /> contato@loquebrinque.com
                    </p>
            ...
            <div className="py-4 text-center text-sm text-gray-800">
                © 2025 <span className={`font-bold ${sniglet.className} text-blue-600`}>
          Loque Brinque
